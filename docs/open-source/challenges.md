...
For architectural considerations and support for multiple releases and products, see use case [Open source software development]({{ site.baseurl }}/open-source/developing-open-source-software/). For solutions regarding installing multiple versions of a component in the system, see [Delivery of open source dependencies in your own products]({{ site.baseurl }}/open-source/using-open-source-software/#auslieferung-von-open-source-abhängigkeiten-in-eigenen-produkten).
{: .solution }
...
To solve the problem, there is tooling in the form of automatic name conflict checking on [dotabap.org](https://dotabap.org), automatic copying of dependencies to other namespaces / prefixes with abaplint and the ABAP open source namespaces. For details see [Namespaces]({{ site.baseurl }}/open-source/developing-open-source-software/#namensräume) and [Delivery of open source dependencies in your own products]({{ site.baseurl }}/open-source/using-open-source-software/#auslieferung-von-open-source-abhängigkeiten-in-eigenen-produkten).
{: .solution }
